...
metaPath = dnPath + 'cfg/' + 'coco.data'

if model_num == 7:
  metaPath = dnPath + 'cfg/' + 'voc.data'
  
metaPath = dnPath + 'data/' + 'combine9k.data'
weightsPath = dnPath + 'weights/' + 'yolo9000' + '.weights'
modelPath = dnPath + 'cfg/' + 'yolo9000' + '.cfg'
  
# Load model
dn.set_gpu(0)
net = dn.load_net(modelPath, weightsPath, 0)
